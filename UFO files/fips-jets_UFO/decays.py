...
Decay_dp = Decay(name = 'Decay_dp',
                 particle = P.dp,
                 partial_widths = {(P.c,P.c__tilde__):'(cv**2*Mdp**4)/(9.*cmath.pi*abs(Mdp)**3)',
                                   (P.d,P.d__tilde__):'(cv**2*Mdp**4)/(36.*cmath.pi*abs(Mdp)**3)',
                                   (P.s,P.s__tilde__):'(cv**2*Mdp**4)/(36.*cmath.pi*abs(Mdp)**3)',
                                   (P.u,P.u__tilde__):'(cv**2*Mdp**4)/(9.*cmath.pi*abs(Mdp)**3)'})
...
Decay_hnl = Decay(name = 'Decay_hnl',
                  particle = P.hnl,
                  partial_widths = {(P.W__plus__,P.e__minus__):'((Mn**2 - MW**2)*(4*cn**2*Mn**2 + (4*cn**2*Mn**4)/MW**2 - 8*cn**2*MW**2))/(32.*cmath.pi*abs(Mn)**3)',
                                    (P.W__plus__,P.mu__minus__):'((Mn**2 - MW**2)*(4*cn**2*Mn**2 + (4*cn**2*Mn**4)/MW**2 - 8*cn**2*MW**2))/(32.*cmath.pi*abs(Mn)**3)',
                                    (P.W__plus__,P.ta__minus__):'((4*cn**2*Mn**2 + 4*cn**2*MTA**2 + (4*cn**2*Mn**4)/MW**2 - (8*cn**2*Mn**2*MTA**2)/MW**2 + (4*cn**2*MTA**4)/MW**2 - 8*cn**2*MW**2)*cmath.sqrt(Mn**4 - 2*Mn**2*MTA**2 + MTA**4 - 2*Mn**2*MW**2 - 2*MTA**2*MW**2 + MW**4))/(32.*cmath.pi*abs(Mn)**3)',
                                    (P.Z,P.ve):'((Mn**2 - MZ**2)*(4*cn**2*Mn**2 + (4*cn**2*Mn**4)/MZ**2 - 8*cn**2*MZ**2))/(32.*cmath.pi*abs(Mn)**3)',
                                    (P.Z,P.vm):'((Mn**2 - MZ**2)*(4*cn**2*Mn**2 + (4*cn**2*Mn**4)/MZ**2 - 8*cn**2*MZ**2))/(32.*cmath.pi*abs(Mn)**3)',
                                    (P.Z,P.vt):'((Mn**2 - MZ**2)*(4*cn**2*Mn**2 + (4*cn**2*Mn**4)/MZ**2 - 8*cn**2*MZ**2))/(32.*cmath.pi*abs(Mn)**3)'})
...
Decay_scalar = Decay(name = 'Decay_scalar',
                     ...
                     partial_widths = {(P.b,P.b__tilde__):'((-24*cs**2*MB**2*MBq**2 + 6*cs**2*MBq**2*Ms**2)*cmath.sqrt(-4*MB**2*Ms**2 + Ms**4))/(16.*cmath.pi*abs(Ms)**3)',
                                       ...
                                       (P.g,P.g):'(cGs**2*cs**2*G**4*Ms**6)/(128.*cmath.pi**5*abs(Ms)**3)',
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.W__minus__,P.hnl):'((4*cn**2*Mn**2 + 4*cn**2*MTA**2 + (4*cn**2*Mn**4)/MW**2 - (8*cn**2*Mn**2*MTA**2)/MW**2 + (4*cn**2*MTA**4)/MW**2 - 8*cn**2*MW**2)*cmath.sqrt(Mn**4 - 2*Mn**2*MTA**2 + MTA**4 - 2*Mn**2*MW**2 - 2*MTA**2*MW**2 + MW**4))/(32.*cmath.pi*abs(MTA)**3)',
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.s__tilde__):'(ee**2*MW**4)/(16.*cmath.pi*sw**2*abs(MW)**3)',
                                          (P.hnl,P.e__plus__):'((-Mn**2 + MW**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MW**2 + 8*cn**2*MW**2))/(48.*cmath.pi*abs(MW)**3)',
                                          (P.hnl,P.mu__plus__):'((-Mn**2 + MW**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MW**2 + 8*cn**2*MW**2))/(48.*cmath.pi*abs(MW)**3)',
                                          (P.hnl,P.ta__plus__):'((-4*cn**2*Mn**2 - 4*cn**2*MTA**2 - (4*cn**2*Mn**4)/MW**2 + (8*cn**2*Mn**2*MTA**2)/MW**2 - (4*cn**2*MTA**4)/MW**2 + 8*cn**2*MW**2)*cmath.sqrt(Mn**4 - 2*Mn**2*MTA**2 + MTA**4 - 2*Mn**2*MW**2 - 2*MTA**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.hnl,P.ve__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.hnl,P.vm__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.hnl,P.vt__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.ve,P.hnl__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.ve,P.ve__tilde__):'(MZ**2*(ee**2*MZ**2 + (cw**2*ee**2*MZ**2)/(2.*sw**2) + (ee**2*MZ**2*sw**2)/(2.*cw**2)))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.vm,P.hnl__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.vm,P.vm__tilde__):'(MZ**2*(ee**2*MZ**2 + (cw**2*ee**2*MZ**2)/(2.*sw**2) + (ee**2*MZ**2*sw**2)/(2.*cw**2)))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.vt,P.hnl__tilde__):'((-Mn**2 + MZ**2)*(-4*cn**2*Mn**2 - (4*cn**2*Mn**4)/MZ**2 + 8*cn**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
