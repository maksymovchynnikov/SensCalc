...
GC_1 = Coupling(name = 'GC_1',
                value = '-(cn*complex(0,1))',
                order = {'NP':1})

GC_2 = Coupling(name = 'GC_2',
                value = '-(cv*complex(0,1))/3.',
                order = {'NP':1})

GC_3 = Coupling(name = 'GC_3',
                value = '(2*cv*complex(0,1))/3.',
                order = {'NP':1})
...
GC_34 = Coupling(name = 'GC_34',
                 value = '(cGs*cs*complex(0,1)*G**2)/(4.*cmath.pi**2)',
                 order = {'NP':2,'QCD':2})
...
GC_36 = Coupling(name = 'GC_36',
                 value = '(cGs*cs*G**3)/(4.*cmath.pi**2)',
                 order = {'NP':2,'QCD':3})

GC_37 = Coupling(name = 'GC_37',
                 value = '-(cGs*cs*complex(0,1)*G**4)/(4.*cmath.pi**2)',
                 order = {'NP':2,'QCD':4})
