...
scalar = Particle(pdg_code = 111111,
                  name = 'scalar',
                  antiname = 'scalar',
                  spin = 1,
                  color = 1,
...
hnl__tilde__ = hnl.anti()

dp = Particle(pdg_code = 111114,
              name = 'dp',
              antiname = 'dp',
              spin = 3,
              color = 1,
