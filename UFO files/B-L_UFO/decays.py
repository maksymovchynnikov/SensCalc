...
Decay_Vb = Decay(name = 'Decay_Vb',
                 particle = P.Vb,
                 partial_widths = {(P.b,P.b__tilde__):'(((8*gV**2*MB**2)/3. + (4*gV**2*MVb**2)/3.)*cmath.sqrt(-4*MB**2*MVb**2 + MVb**4))/(48.*cmath.pi*abs(MVb)**3)',
                                   (P.c,P.c__tilde__):'(gV**2*MVb**4)/(36.*cmath.pi*abs(MVb)**3)',
                                   (P.chi__tilde__,P.chi):'((-4*gV**2*Mchi**2*Qchi**2 + gV**2*MVb**2*Qchi**2)*cmath.sqrt(-4*Mchi**2*MVb**2 + MVb**4))/(48.*cmath.pi*abs(MVb)**3)',
                                   (P.d,P.d__tilde__):'(gV**2*MVb**4)/(36.*cmath.pi*abs(MVb)**3)',
                                   (P.e__minus__,P.e__plus__):'(gV**2*MVb**4)/(12.*cmath.pi*abs(MVb)**3)',
                                   (P.mu__minus__,P.mu__plus__):'(gV**2*MVb**4)/(12.*cmath.pi*abs(MVb)**3)',
                                   (P.s,P.s__tilde__):'(gV**2*MVb**4)/(36.*cmath.pi*abs(MVb)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((8*gV**2*MTA**2 + 4*gV**2*MVb**2)*cmath.sqrt(-4*MTA**2*MVb**2 + MVb**4))/(48.*cmath.pi*abs(MVb)**3)',
                                   (P.u,P.u__tilde__):'(gV**2*MVb**4)/(36.*cmath.pi*abs(MVb)**3)',
                                   (P.ve,P.ve__tilde__):'(gV**2*MVb**4)/(12.*cmath.pi*abs(MVb)**3)',
                                   (P.vm,P.vm__tilde__):'(gV**2*MVb**4)/(12.*cmath.pi*abs(MVb)**3)',
                                   (P.vt,P.vt__tilde__):'(gV**2*MVb**4)/(12.*cmath.pi*abs(MVb)**3)'})
